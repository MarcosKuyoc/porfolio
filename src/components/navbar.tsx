export const Navbar = () => {
  return (
    <>
      <div className="h-1/5 flex justify-center pt-5 pb-5 md:hidden">
        <a href="#page-top" className="pl-10 text-2xl">
          Marcos Kuyoc
        </a>
        <button
          data-collapse-toggle="navbar-default"
          type="button"
          className="ml-3 p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      ...
      <nav className="h-3/4 max-md:hidden">
        <div className="flex justify-center" id="navbar-default">
          <ul className="w-full text-center text-white">
            <li className="bg-zinc-600">
              <div className="flex flex-row pt-2 pb-2 pl-10">
                ...
                <a href="#marcos" className="tracking-wider font-extrabold ml-2" aria-current="page">index</a>
              </div>
            </li>
            <li className="hover:bg-zinc-600">
              <div className="flex flex-row pt-2 pb-2 pl-10">
                ...
                <a href="#about" className="tracking-wider font-extrabold ml-2">Sobre mi</a>
              </div>
            </li>
            <li className="hover:bg-zinc-600">
              <div className="flex flex-row pt-2 pb-2 pl-10">
                ...
                <a href="#porfolio" className="tracking-wider font-extrabold ml-2">Porfolio</a>
              </div>
            </li>
            <li className="hover:bg-zinc-600">
              <div className="flex flex-row pt-2 pb-2 pl-10">
                ...
                <a href="#skills" className="tracking-wider font-extrabold ml-2">Skills</a>
              </div>
            </li>
            <li className="hover:bg-zinc-600">
              <div className="flex flex-row pt-2 pb-2 pl-10">
                ...
                <a href="#proyectos" className="tracking-wider font-extrabold ml-2">Proyectos</a>
              </div>
            </li>
            <li className="hover:bg-zinc-600">
              <div className="flex flex-row pt-2 pb-2 pl-10">
                ...
                <a href="#contacto" className="tracking-wider font-extrabold ml-2">Contacto</a>
              </div>
            </li>
          </ul>
        </div>
    ...
    // <>
    //   <div className="flex pt-5 pb-5 md:hidden">
    //     <a href="#page-top" className="pl-10 text-2xl">
    //       Juan Marcos
    //     </a>
    //     <button
    //       data-collapse-toggle="navbar-default"
    //       type="button"
    //       className="ml-3 p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
    //       aria-controls="navbar-default"
    //       aria-expanded="false">
    //       <span className="sr-only">Open main menu</span>
    //       <svg className="w-6 h-6" aria-hidden="true" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
